  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.18);borderRadius:15px">
        <h1 class="h1" style="color:rgba(64, 158, 255, 1);fontSize:28px;">预约挂号系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.suoshuyiyuan" class="input" type="text" placeholder="所属医院">
			   </div>
			 </div> -->
			<el-form-item label="所属医院" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.suoshuyiyuan" autocomplete="off" placeholder="所属医院"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			...
			<!-- <div v-if="tableName=='jigou'" class="input-group">
			   <div class="label">医院账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yiyuanzhanghao" class="input" type="text" placeholder="医院账号">
			   </div>
			 </div> -->
			<el-form-item label="医院账号" class="input" v-if="tableName=='jigou'">
			  <el-input v-model="ruleForm.yiyuanzhanghao" autocomplete="off" placeholder="医院账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jigou'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jigou'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='jigou'" class="input-group">
			...
			<el-form-item label="医院名称" class="input" v-if="tableName=='jigou'">
			  <el-input v-model="ruleForm.yiyuanmingcheng" autocomplete="off" placeholder="医院名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jigou'" class="input-group">
			   <div class="label">医院等级</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yiyuandengji" class="input" type="text" placeholder="医院等级">
			   </div>
			 </div> -->
			<el-form-item label="医院等级" class="input" v-if="tableName=='jigou'">
			  <el-input v-model="ruleForm.yiyuandengji" autocomplete="off" placeholder="医院等级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jigou'" class="input-group">
			...
			<el-form-item label="医院地址" class="input" v-if="tableName=='jigou'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='jigou'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jigou'" class="input-group">
			...
			<el-form-item label="营业时间" class="input" v-if="tableName=='jigou'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.yiyuanzhanghao) && `jigou` == this.tableName){
        this.$message.error(`医院账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `jigou` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`jigou` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      this.$http({

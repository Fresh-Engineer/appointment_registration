  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="所属医院" prop="suoshuyiyuan">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='jigou'" label="医院图片" prop="yiyuantupian">
          ...
          @change="jigouyiyuantupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jigou'"  label="医院地址" prop="yiyuandizhi">
          <el-input v-model="ruleForm.yiyuandizhi"               placeholder="医院地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jigou'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jigou'"  label="营业时间" prop="yingyeshijian">
...
export default {
  ...
  methods: {
    ...
    jigouyiyuantupianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.yiyuanzhanghao)&& 'jigou'==this.flag){
        this.$message.error('医院账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'jigou'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if( 'jigou' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }

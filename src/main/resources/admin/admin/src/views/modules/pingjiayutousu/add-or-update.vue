        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fuwupingjia" label="服务评价" prop="fuwupingjia">
                    <span>{{ruleForm.fuwupingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="投诉建议" prop="tousujianyi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tousujianyi" label="投诉建议" prop="tousujianyi">
                    <span>{{ruleForm.tousujianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `pingjiayutousu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pingjiayutousuCrossAddOrUpdateFlag = false;
                  this.parent.search();

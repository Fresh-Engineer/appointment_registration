<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院账号" prop="yiyuanzhanghao">
          <el-input v-model="ruleForm.yiyuanzhanghao" 
              placeholder="医院账号" clearable  :readonly="ro.yiyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医院账号" prop="yiyuanzhanghao">
              <el-input v-model="ruleForm.yiyuanzhanghao" 
                placeholder="医院账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医院名称" prop="yiyuanmingcheng">
          <el-select v-model="ruleForm.yiyuanmingcheng" placeholder="请选择医院名称">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="特色科室" prop="tesekeshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="特色科室"
                  v-model="ruleForm.tesekeshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tesekeshi" label="特色科室" prop="tesekeshi">
                    <span>{{ruleForm.tesekeshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="专家" prop="zhuanjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="专家"
                  v-model="ruleForm.zhuanjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanjia" label="专家" prop="zhuanjia">
                    <span>{{ruleForm.zhuanjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xiangxijieshao : false,
      ...
      rules: {
          yiyuanzhanghao: [
                { required: true, message: '医院账号不能为空', trigger: 'blur' },
          ],
          yiyuanmingcheng: [
          ],
          tesekeshi: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuanmingcheng = true;
          ...
          if(o=='tesekeshi'){
            this.ruleForm.tesekeshi = obj[o];
	    this.ro.tesekeshi = true;
            continue;
          }
          if(o=='zhuanjia'){
            this.ruleForm.zhuanjia = obj[o];
	    this.ro.zhuanjia = true;
            continue;
          }
          if(o=='yiyuantupian'){
      ...
      this.$http({
		...
		if(json.yiyuantupian!=''&&json.yiyuantupian){
              		this.ruleForm.yiyuantupian = json.yiyuantupian
		}
		...
		if(json.yingyeshijian!=''&&json.yingyeshijian){
              		this.ruleForm.yingyeshijian = json.yingyeshijian
		}
		if(json.xiangxijieshao!=''&&json.xiangxijieshao){
              		this.ruleForm.xiangxijieshao = json.xiangxijieshao
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/jigou/yiyuanmingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.xiangxijieshao = this.ruleForm.xiangxijieshao.replace(reg,'../../../springbootweb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="医生姓名" prop="yishengxingming">
          <el-select v-model="ruleForm.yishengxingming" placeholder="请选择医生姓名">
            <el-option
                v-for="(item,index) in yishengxingmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属医院" prop="suoshuyiyuan">
          <el-input v-model="ruleForm.suoshuyiyuan" 
              placeholder="所属医院" clearable  :readonly="ro.suoshuyiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属医院" prop="suoshuyiyuan">
              <el-input v-model="ruleForm.suoshuyiyuan" 
                placeholder="所属医院" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="擅长疾病" prop="shanzhangjibing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shanzhangjibing" label="擅长疾病" prop="shanzhangjibing">
                    <span>{{ruleForm.shanzhangjibing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="挂号须知" prop="guahaoxuzhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="挂号须知"
                  v-model="ruleForm.guahaoxuzhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guahaoxuzhi" label="挂号须知" prop="guahaoxuzhi">
                    <span>{{ruleForm.guahaoxuzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="医生详情" prop="yishengxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yishengxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yishengxiangqing" label="医生详情" prop="yishengxiangqing">
                    <span v-html="ruleForm.yishengxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='yishengxiangqing'){
            this.ruleForm.yishengxiangqing = obj[o];
	    this.ro.yishengxiangqing = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.suoshuyiyuan!=''&&json.suoshuyiyuan){
              		this.ruleForm.suoshuyiyuan = json.suoshuyiyuan
		}
		...
		if(json.yishengxiangqing!=''&&json.yishengxiangqing){
              		this.ruleForm.yishengxiangqing = json.yishengxiangqing
		}
        } else {
	...
	this.ruleForm.yishengxiangqing = this.ruleForm.yishengxiangqing.replace(reg,'../../../springbootweb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

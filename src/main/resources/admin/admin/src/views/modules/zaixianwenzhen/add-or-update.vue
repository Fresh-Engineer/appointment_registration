    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="问诊情况" prop="wenzhenqingkuang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wenzhenqingkuang" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wenzhenqingkuang" label="问诊情况" prop="wenzhenqingkuang">
                    <span v-html="ruleForm.wenzhenqingkuang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangguantupian = true;
          ...
          if(o=='wenzhenqingkuang'){
            this.ruleForm.wenzhenqingkuang = obj[o];
	    this.ro.wenzhenqingkuang = true;
            continue;
          }
          if(o=='userid'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yishengxinxi/yishenggonghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    yishenggonghaoChange () {
      this.$http({
        url: `follow/yishengxinxi/yishenggonghao?columnValue=`+ this.ruleForm.yishenggonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              ...
              if(data.data.suoshuyiyuan){
                this.ruleForm.suoshuyiyuan = data.data.suoshuyiyuan
              }
              if(data.data.keshi){
	...
	this.ruleForm.wenzhenqingkuang = this.ruleForm.wenzhenqingkuang.replace(reg,'../../../springbootweb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
